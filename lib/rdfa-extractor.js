...
import { RdfaParser } from '@nbittich/rdfa-streaming-parser';
...
const PROV_VALUE_PREFIX = "http://www.w3.org/ns/prov#value";
...
export default class RDFAextractor {
  async extractPage(filePath, fileMetadata) {
    ...
    const parser = new RdfaParser({ baseIRI: fileMetadata.url, htmlPredicates: [PROV_VALUE_PREFIX] });
